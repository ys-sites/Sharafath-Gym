...
const MOCK_LIBRARY = [
  ...
  { id: 'ex1', name: 'Machine Chest Press' },
  { id: 'ex2', name: 'Incline Dumbbell Press' },
  { id: 'ex3', name: 'Machine Pec Deck Fly' },
  { id: 'ex4', name: 'Dumbbell Lateral Raise' },
  { id: 'ex6', name: 'Tricep Pushdown' },
  { id: 'ex8', name: 'Wide-Grip Lat Pulldown' },
  { id: 'ex10', name: 'Seated Cable Row' },
  { id: 'ex12', name: 'Lat Pullover Machine' },
  { id: 'ex13', name: 'Preacher Curl' },
  { id: 'ex16', name: 'Hack Squat' },
  { id: 'ex17', name: 'Leg Press' },
  { id: 'ex18', name: 'Leg Extension' },
  { id: 'ex19', name: 'Romanian Deadlift (Dumbbell)' },
  { id: 'ex20', name: 'Seated Leg Curl' },
  { id: 'ex21', name: 'Standing Calf Raise' },
  { id: 'ex22', name: 'Seated Leg Raises' },
];
