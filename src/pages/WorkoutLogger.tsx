...
const MOCK_LIBRARY = [
  ...
  { id: 'ex3', name: 'Machine Pec Deck Fly', youtube_url: 'https://www.youtube.com/watch?v=4zV2Q1B5v6g' },
  { id: 'ex4', name: 'Dumbbell Lateral Raise', youtube_url: 'https://www.youtube.com/watch?v=PzsMitRdI_8' },
  { id: 'ex6', name: 'Tricep Pushdown', youtube_url: 'https://www.youtube.com/watch?v=2-LAMcpzODU' },
  { id: 'ex8', name: 'Wide-Grip Lat Pulldown', youtube_url: 'https://www.youtube.com/watch?v=CAwf7n6Luuc' },
  { id: 'ex9', name: 'Close-Grip Lat Pulldown', youtube_url: 'https://www.youtube.com/watch?v=8d22D_B0UeM' },
  { id: 'ex10', name: 'Seated Cable Row', youtube_url: 'https://www.youtube.com/watch?v=GZBFZst_kXg' },
  { id: 'ex12', name: 'Lat Pullover Machine', youtube_url: 'https://www.youtube.com/watch?v=QdD8Jv2h_6U' },
  { id: 'ex13', name: 'Preacher Curl', youtube_url: 'https://www.youtube.com/watch?v=fIWP-FRFNU0' },
  { id: 'ex16', name: 'Hack Squat', youtube_url: 'https://www.youtube.com/watch?v=0p3_N1YvP0E' },
  { id: 'ex17', name: 'Leg Press', youtube_url: 'https://www.youtube.com/watch?v=IZxyjW7MPJQ' },
  { id: 'ex18', name: 'Leg Extension', youtube_url: 'https://www.youtube.com/watch?v=YyvSfV9Qp60' },
  { id: 'ex19', name: 'Romanian Deadlift (Dumbbell)', youtube_url: 'https://www.youtube.com/watch?v=JGrD4N-_s44' },
  { id: 'ex20', name: 'Seated Leg Curl', youtube_url: 'https://www.youtube.com/watch?v=Orxowest56U' },
  { id: 'ex21', name: 'Standing Calf Raise', youtube_url: 'https://www.youtube.com/watch?v=N38e_lE9e08' },
  { id: 'ex22', name: 'Seated Leg Raises', youtube_url: 'https://www.youtube.com/watch?v=HbbOplfPjB0' },
];
